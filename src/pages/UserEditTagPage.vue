...
onMounted(async () => {
  ...
  if(currentUser.tags !== null){
    // let oldTags = Array.from(currentUser.tags);
    // let oldTags = JSON.parse(currentUser.tags);
    let oldTags = editTags.value.currentValue;
    console.log(oldTags);
    oldTags.forEach((i: any)=>
    {
      //添加至tagList
