<template>
<!--  <van-nav-bar fixed="fixed" left-arrow left-text="返回" :title="title" >-->
<!--  </van-nav-bar>-->
  ...
  <div class="login-page">
    ...
    <van-form @submit="onSubmit" class="login-form">
      ...
      <div class="actions">
        ...
        <br>
        <van-button round block type="default" @click="useEmailLogin" >
...
const onSubmit = async () => {
  ...
  if (res.code === 0 && res.data) {
   ...
   // console.log(Rest.data, '当前用户');
    Toast.success(Rest.data);
    if (Rest.code === 0) {
...
const useEmailLogin = () => {
  ...
  // window.location.href = '/user/login/email';
};
</script>
