...
var S = {
  "emoji-container": "V3Emoji-module__emoji-container___Q64PE",
  "emoji-container-open-btn": "V3Emoji-module__emoji-container-open-btn___Ru3N1",
  "emoji-item": "V3Emoji-module__emoji-item___aCxWs",
  "emoji-textarea": "V3Emoji-module__emoji-textarea___ifCpb",
  "emoji-textarea-pollup-container": "V3Emoji-module__emoji-textarea-pollup-container___r9FWA",
  "emoji-textarea-open-btn": "V3Emoji-module__emoji-textarea-open-btn___Cspp1",
  "emoji-input": "V3Emoji-module__emoji-input___IDzL2"
};
var re = [
  {
    emoji: "\u{1F383}",
...
var de = "PollUp-module__pollup___MaX-h";
var fe = "PollUp-module__active___Byv7D";
var b = {
  pollup: de,
  "tab-name": "PollUp-module__tab-name___p45H-",
  "delete-recent": "PollUp-module__delete-recent___0sD5T",
  "emoji-container": "PollUp-module__emoji-container___3g6Uq",
  "emoji-container-item": "PollUp-module__emoji-container-item___A4VoM",
  "tab-container": "PollUp-module__tab-container___monWD",
  "tab-item": "PollUp-module__tab-item___1Olzf",
  active: fe
};
var ke = (e = 13, _) => _.filter((o) => o.unicode_version ? !(Number.parseInt(o.unicode_version) > e) : true);
var he = (e, _ = {}, o = 11, g = [], p = {}) => {
  const c = {}, y = __spreadValues(__spreadValues({}, e), p);
  for (const r in y)
    _.hasOwnProperty(r) ? c[_[r]] = y[r] : c[r] = y[r];
  for (const r of g)
    c.hasOwnProperty(r) && delete c[r];
  for (const r in c)
    c[r] = ke(o, c[r]);
  return c;
};
var J = (e, _) => {
  if (typeof _ == "object")
    localStorage.setItem(e, JSON.stringify(_));
  else if (typeof _ == "string")
    try {
      localStorage.setItem(e, _);
    } catch {
...
var be = (e) => {
  try {
    const _ = localStorage.getItem(e);
    return _ === null ? null : JSON.parse(_);
  } catch {
...
var ye = (e, _) => {
  if (!e.value)
    J("emoji-recent", { recent: [_] });
  else {
    if (e.value.recent.length < 50) {
      const o = e.value.recent.findIndex((g) => g.emoji === _.emoji);
      o === -1 || e.value.recent.splice(o, 1), e.value.recent.unshift(_);
    } else
      e.value.recent.unshift(_), e.value.recent.pop();
    J("emoji-recent", e.value);
  }
};
var xe = createBaseVNode("p", { sytle: "margin:0 5px;" }, "\u6700\u8FD1\u4F7F\u7528", -1);
var ze = ["onClick", "title", "innerHTML"];
var Se = ["onClick", "title", "innerHTML"];
var qe = ["title", "onClick"];
var G = defineComponent({
  ...
  setup(e, { emit: _ }) {
    const o = e, g = {
      ...
      light: "&#127995;",
      none: ""
    }, p = me, c = ce, y = ge, r = [], d = ref("Smileys & Emotion"), a = ref(), u = ref(), E = he(p, o.optionsName, o.unicodeVersion, o.disableGroup, o.customTab), x = ref(be("emoji-recent") || null), T = ref({}), q = ref(), C = ref(), t = computed(() => x.value && x.value.recent || []), s = (i) => {
      if (i.skin_tone_support)
        if (i.skin_tone_support_unicode_version) {
          const f = Number.parseInt(i.skin_tone_support_unicode_version) < 10 ? g[o.skin] : "";
          return `${i.emoji}${f}`;
        } else
          return i.emoji;
      else
      ...
      for (let i in E)
        r.push(i);
      x.value === null && o.needLocal && (x.value = {
        recent: []
      }, J("emoji-recent", x.value)), o.defaultSelect && (r.includes(o.defaultSelect) || o.defaultSelect === "recent" && o.needLocal) ? d.value = o.defaultSelect : d.value = r[0];
    }, F = (i) => {
      d.value = i;
    }, U = (i) => {
      o.needLocal && ye(x, i), _("clickEmoji", i);
    }, ee = () => {
      x.value.recent = [], we("emoji-recent");
    }, oe = () => {
      if (a.value) {
        const i = a.value.getBoundingClientRect();
        let f = {};
        i.top < 0 ? f = { bottom: "unset", top: "50px" } : i.left < 0 ? f = { left: "0px", right: "unset" } : i.right > window.innerWidth ? f = { right: "0px", left: "unset" } : i.bottom > window.innerHeight && (f = { bottom: "50px", top: "unset" }), T.value = Object.assign(a.value.style, f);
      }
    }, ne = () => {
      if (a.value) {
        const i = {
        ...
        T.value = i[o.fixPos || "upleft"] || {};
      }
    }, $ = () => {
      if (a.value) {
        let i, f;
        for (let l in c[o.size])
          switch (o.customSize && o.customSize[l] ? a.value.style.setProperty(`--${l}`, o.customSize[l]) : a.value.style.setProperty(`--${l}`, c[o.size][l]), l) {
            case "V3Emoji-itemSize":
              i = o.customSize && o.customSize[l] || c[o.size][l];
              break;
            case "V3Emoji-height":
              f = o.customSize && o.customSize[l] || c[o.size][l];
              break;
          }
        if (C.value) {
          let l = parseInt(f) - parseInt(i) * 2 - 20 - parseInt(i) / 2;
          q.value && q.value.scrollWidth > q.value.clientWidth && (l = parseInt(f) - parseInt(i) * 2 - 2 * 10 - (parseInt(i) / 2 + 4)), C.value.style["max-height"] = `${l}px`;
        }
      }
    }, D = () => {
      if (a.value)
        for (let i in y[o.theme])
          o.customTheme && o.customTheme[i] ? a.value.style.setProperty(`--${i}`, o.customTheme[i]) : a.value.style.setProperty(`--${i}`, y[o.theme][i]);
    };
    return watchEffect(() => {
      z(), $(), D();
    }), onMounted(() => {
      $(), D(), ne(), u.value = new IntersectionObserver((i) => {
        i.forEach(oe, { threshold: 0.3 });
      }), a.value && u.value.observe(a.value);
    }), onBeforeUnmount(() => {
      var i;
      a.value && ((i = u.value) == null || i.disconnect());
    }), (i, f) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(unref(b).pollup),
      ref_key: "pollUpEl",
      ref: a,
      style: normalizeStyle(unref(T))
    }, [
      unref(d) === "recent" ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass(unref(b)["tab-name"])
      }, [
        xe,
        createBaseVNode("a", {
          class: normalizeClass(unref(b)["delete-recent"]),
          onClick: ee
        }, "\u5220\u9664\u6240\u6709\u9009\u9879", 2)
      ], 2)) : (openBlock(), createElementBlock("p", {
        key: 1,
        class: normalizeClass(unref(b)["tab-name"])
      }, toDisplayString(unref(d)), 3)),
      createBaseVNode("div", {
        class: normalizeClass(unref(b)["emoji-container"]),
        ref_key: "container",
        ref: C
      }, [
        unref(d) === "recent" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(t), (v, l) => (openBlock(), createElementBlock("div", {
          class: normalizeClass(unref(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
          innerHTML: s(v)
        }, null, 10, ze))), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(unref(E)[unref(d)], (v, l) => (openBlock(), createElementBlock("div", {
          class: normalizeClass(unref(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
      ...
      createBaseVNode("div", {
        class: normalizeClass(unref(b)["tab-container"]),
        ref_key: "tabcontainer",
        ref: q
      }, [
        e.needLocal ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass([unref(b)["tab-item"], unref(d) === "recent" ? unref(b).active : ""]),
          onClick: f[0] || (f[0] = (v) => F("recent"))
        }, " \u{1F525} ", 2)) : createCommentVNode("", true),
        (openBlock(), createElementBlock(Fragment, null, renderList(r, (v) => createBaseVNode("div", {
          class: normalizeClass([unref(b)["tab-item"], v === unref(d) ? unref(b).active : ""]),
          title: v,
          key: v,
          onClick: (l) => F(v)
        }, toDisplayString(e.customIcon && e.customIcon[v] ? e.customIcon[v] : unref(E)[v][0].emoji), 11, qe)), 64))
      ], 2)
    ], 6));
  }
});
var Ce = ["placeholder", "rows", "cols"];
var Ee = ["placeholder"];
var L = defineComponent({
  ...
  setup(e, { expose: _, emit: o }) {
    const g = e, p = ref(g.modelValue), c = ref(), y = ref(), r = ref(), d = ref(0), a = ref(0), u = ref(false), E = (t) => {
      let s = t.target;
      if (s) {
        for (; s.className && s.className !== "pollup"; )
          s = s.parentNode;
        return !(s.className && s.className === "pollup");
      } else
        return false;
    }, x = (t) => {
      var s;
      g.manualClose || !((s = c.value) != null && s.contains(t.target)) && E(t) && (u.value = false, o("close"));
    }, T = () => {
      u.value = false;
    }, q = (t) => {
      if (g.textArea) {
        let s = p.value.substring(0, d.value), z = p.value.substring(a.value, p.value.length);
        p.value = s + t.emoji + z, d.value = s.length + t.emoji.length, a.value = s.length + t.emoji.length;
      }
      o("clickEmoji", g.fulldata ? t : t.emoji);
    }, C = (t) => {
      g.textArea && (g.inputType === "textarea" ? (d.value = y.value.selectionStart, a.value = y.value.selectionEnd) : (d.value = r.value.selectionStart, a.value = r.value.selectionEnd)), t && !g.manualClose && (u.value = false);
    };
    return _({
      closePop: T
    }), watchEffect(() => {
      o("update:modelValue", p.value), o("changeText", p.value);
    }), watch(g, (t) => {
      p.value = g.modelValue;
    }), onMounted(() => {
      document.addEventListener("click", x);
    }), onBeforeUnmount(() => {
      document.removeEventListener("click", x);
    }), (t, s) => (openBlock(), createElementBlock("div", {
      id: "EmojiItem",
      class: normalizeClass(unref(S)["emoji-item"]),
      ref_key: "EmojiEl",
      ref: c
    }, [
      e.textArea ? e.inputType === "textarea" ? (openBlock(), createElementBlock("div", {
        key: 1,
        class: normalizeClass(unref(S)["emoji-textarea"])
      }, [
        withDirectives(createBaseVNode("textarea", {
          "onUpdate:modelValue": s[1] || (s[1] = (z) => isRef(p) ? p.value = z : null),
          ref_key: "textarea",
          ref: y,
          placeholder: e.textAreaOption.placeholder,
          rows: e.textAreaOption.rows,
          cols: e.textAreaOption.cols,
          onBlur: C,
          onFocus: C,
          style: normalizeStyle({ resize: e.textAreaOption.resize })
        }, null, 44, Ce), [
          [vModelText, unref(p)]
        ]),
        createBaseVNode("div", {
          class: normalizeClass(unref(S)["emoji-textarea-pollup-container"])
        }, [
          createBaseVNode("div", {
            onClick: s[2] || (s[2] = (z) => u.value = !unref(u)),
            class: normalizeClass(unref(S)["emoji-textarea-open-btn"])
          }, [
            renderSlot(t.$slots, "default", {}, () => [
              createTextVNode("\u{1F600}")
            ])
          ], 2),
          unref(u) && e.textArea || e.keep ? withDirectives((openBlock(), createBlock(G, {
            key: 0,
            onClickEmoji: q,
            size: e.size,
            theme: e.theme,
            skin: e.skin,
            disableGroup: e.disableGroup,
            optionsName: e.optionsName,
            "unicode-version": e.unicodeVersion,
            "need-local": e.recent,
            defaultSelect: e.defaultSelect,
            customSize: e.customSize,
            customIcon: e.customIcon,
            customTheme: e.customTheme,
            customTab: e.customTab,
            fixPos: e.fixPos
            ...
            [vShow, e.keep ? unref(u) : true]
          ]) : createCommentVNode("", true)
        ], 2)
      ], 2)) : (openBlock(), createElementBlock("div", {
        key: 2,
        class: normalizeClass(unref(S)["emoji-input"])
      }, [
        withDirectives(createBaseVNode("input", {
          "onUpdate:modelValue": s[3] || (s[3] = (z) => isRef(p) ? p.value = z : null),
          ref_key: "inputArea",
          ref: r,
          placeholder: e.textAreaOption.placeholder,
          onBlur: C,
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            onClick: s[4] || (s[4] = (z) => u.value = !unref(u)),
            class: normalizeClass(unref(S)["emoji-textarea-open-btn"])
          }, [
            renderSlot(t.$slots, "default", {}, () => [
              createTextVNode("\u{1F600}")
        ...
        key: 0,
        class: normalizeClass(unref(S)["emoji-container"])
      }, [
        createBaseVNode("div", {
          class: normalizeClass(unref(S)["emoji-container-open-btn"]),
          onClick: s[0] || (s[0] = (z) => u.value = !unref(u))
        }, [
          renderSlot(t.$slots, "default", {}, () => [
            createTextVNode("\u{1F600}")
          ])
...
// dep:vue3-emoji
var vue3_emoji_default = L;
export {
  vue3_emoji_default as default
};
